...
// const ApiServerURL = 'http://14.225.19.25:8777/api/v1/';
const ApiServerURL = "https://apibd.txng.gov.vn/api/v1/";
...
class Axios {
    ...
    constructor() {
        ...
        instance.interceptors.request.use(
            (config: any) => {
                // const accessToken = 'Bearer ' + store.getState().auth.loginSuccess.token;
                // if (config.headers) {
                //   if (accessToken) {
